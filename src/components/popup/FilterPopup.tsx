...
import { applyPriorityFilter, applySortFieldFilter, applySortOrderFilter, toggleIncludeCompleted } from '@/store/slices/todoSlice';
...
const FilterPopup: React.FC<FilterPopupPropType> = ({ filterButtonRef, closePopup, popup }) => {
    ...
    return (
        <div id='filter-popup' ref={popupRef} className={`p-3 absolute top-16 right-0 z-10 rounded-md overflow-hidden origin-top-right transition-all duration-300 ease-in-out ${popup ? 'scale-100 opacity-100' : 'scale-0 opacity-0'} bg-white shadow border-1 dark:shadow-none border-gray-100 dark:bg-zinc-800 dark:border-zinc-600
`}>
            <section id="priority">
                ...
                <div>
                    ...
                    <div className="flex items-center justify-between gap-2">
                        ...
                        <select
                            ...
                            className="p-0.5 border-1 text-gray-500 dark:text-zinc-300 border-zinc-500 text-xs rounded-md focus:outline-0"
                        >
                    ...
                    <div className="flex items-center mt-2 gap-2 justify-between">
                        ...
                        <select
                            ...
                            className="p-0.5 border-1 disabled:dark:dark:bg-zinc-500 disabled:bg-gray-200 disabled:opacity-50 text-gray-500 dark:text-zinc-300 border-zinc-500 rounded-md text-xs focus:outline-0"
                        >
